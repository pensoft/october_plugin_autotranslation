...
class AutoTranslate extends Controller
{
     ...
     */
    protected function getModelDiscovery(): ModelDiscoveryService
    {
    ...
    public function messages()
    {
        ...
        $this->vars['locales'] = Locale::listLocales()->where('is_enabled', true);
     ...
     */
    protected function getMessageTranslationData(): array
    {
     ...
     */
    protected function validateMessageTranslationData(array $data): bool
    {
     ...
     */
    protected function performMessagesTranslation(array $data): int
    {
     ...
     */
    protected function showTranslationResult(int $totalTranslated): void
    {
     ...
     */
    protected function handleTranslationError(string $context, \Exception $e): void
    {
     ...
     */
    protected function getModelTranslationData(): array
    {
        $sourceLocale = $this->getConfiguredSourceLocale();
     ...
     */
    protected function validateModelTranslationData(array $data): bool
    {
     ...
     */
    protected function performModelsTranslation(array $data): int
    {
        $manager = $this->getTranslationManager();
        $translatedCount = 0;
     ...
     */
    protected function showModelTranslationResult(int $translatedCount): void
    {
     ...
     */
    protected function logAvailableLanguages(DeepLTranslator $translator): void
    {
     ...
     */
    protected function makeUsagePartial($usage): array
    {
        return [
     ...
     */
    protected function makeUsageErrorPartial(\Exception $e): array
    {
        return [
     ...
     * Make stats response
     */
    protected function makeStatsResponse(array $stats, string $sourceLocale, string $targetLocale): array
    {
        return [
            'stats' => $stats,
